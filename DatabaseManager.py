...
class DatabaseManager:
    def __init__(self, db_dir, domain):
        self.database_name = self.get_database_name(domain, db_dir)
        self.init_db()
    ...
    def save_links_to_db(self, domain, links, robots_parser, status="pending"):
    ...
    def update_link_in_db(self, link, content, content_hash, status="crawled"):
    ...
    def check_re_crawl(self, link, re_crawl_time):
        """
    ...
    def get_database_name(self, domain, db_dir):
